...
const ProductListScreen = {
    after_render: () => {
        ...
        Array.from(editButtons).forEach((editButton) => editButton.addEventListener('click', () => {
            document.location.hash = `/product/${editButton.id}/edit`; /* ${editButton.id} contains the product id, this is defined below at the Button tag. This is why both Edit and Delete buttons have the same id convention */
        }));
    },
    render: async () => {
